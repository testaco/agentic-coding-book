...
requirements:
  ...
  - REQ-C040
  - REQ-C044
abstract: Section 10 of What is Agentic Coding?
---
...
- **Previous**: [The Renaissance Developer](../01-renaissance-developer/01-introduction-the-specialist-s-dilemma.md) - The mindset foundation that makes agentic coding effective. Understanding the Renaissance Developer model—being "good enough at everything"—is crucial context for why agentic coding matters.
